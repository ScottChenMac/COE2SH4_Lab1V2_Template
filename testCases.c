...
//=========Question 1==================================
    ...
    void TestQ1_for_Custom()
    {
        ...
        printf("[Q1 REMINDER]: Add 3 more test cases under TestQ1_for_Custom()!!\n");
    ...
    void TestQ1_while_Custom()
    {
        ...
        // Add three more test cases here
        printf("[Q1 REMINDER]: Add 3 more test cases under TestQ1_while_Custom()!!\n");
    ...
    void TestQ1_dowhile_Custom()
    {
        ...
        // Add three more test cases here
        printf("[Q1 REMINDER]: Add 3 more test cases under TestQ1_dowhile_Custom()!!\n");
...
//=================Question 2================================
    ...
    void TestQ2_Custom()
    {
        ...
        // Add three more test cases here
        printf("[Q2 REMINDER]: Add 3 more test cases under TestQ2_Custom()!!\n");
...
//=================Question 3================================   
    ...
    void TestQ3_Custom()
    {
        ...
        printf("[Q3 REMINDER]: Add 1 more test case under TestQ3_Custom()!!\n");
...
//=================Question 4================================ 
    ...
    void TestQ4_Custom()
    {
        ...
        // Add another test case here
        printf("[Q4 REMINDER]: Add 1 more test case under TestQ4_Custom()!!\n");
